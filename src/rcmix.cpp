...
int main(int argc, char** argv){
    ...
    std::cout << "[mass   picture] default r_m: " << cc_hl << "\n";
    std::cout << "---RCST-------envi-------r_m: " << cc_envi_rc << "\n";
    std::cout << "---RCST-------mass-------r_m: " << cc_mass_rc << "\n";
    std::cout << "---RCST----envi + mass---r_m: " << cc_con_rc << "\n";
    std::cout << "---RCST----envi * mass---r_m: " << cc_mul_rc << "\n";
